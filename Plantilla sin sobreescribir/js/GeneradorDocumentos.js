function generarDocumento(nombrePlantilla, nombreDocumento)
{
	...
	loadFile(nombrePlantilla,function(err,content){
                ...
                doc.setData(getData(cargaDocumento(nombreDocumento);)) //set the templateVariables
...
function cargaDocumento(nombreDocumento)
{
    loadFile(nombreDocumento,function(err,content){
